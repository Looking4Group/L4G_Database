...
-- Dumping structure for table progress_world.playercreateinfo_action
...
-- Dumping data for table progress_world.playercreateinfo_action: ~293 rows (approximately)
