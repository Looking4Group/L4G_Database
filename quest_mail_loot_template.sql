...
-- Dumping structure for table progress_world.quest_mail_loot_template
...
-- Dumping data for table progress_world.quest_mail_loot_template: ~66 rows (approximately)
