...
-- Dumping structure for table sully_world.scripted_spell_id
...
-- Dumping data for table sully_world.scripted_spell_id: ~15 rows (approximately)
DELETE FROM `scripted_spell_id`;
