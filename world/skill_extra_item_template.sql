...
-- Dumping structure for table progress_world.skill_extra_item_template
...
-- Dumping data for table progress_world.skill_extra_item_template: ~161 rows (approximately)
