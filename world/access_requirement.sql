...
INSERT INTO `access_requirement` (`id`, `level_min`, `level_max`, `item`, `item2`, `heroic_key`, `heroic_key2`, `quest_done`, `quest_failed_text`, `heroic_quest_done`, `heroic_quest_failed_text`, `aura_id`, `missing_aura_text`, `comment`) VALUES
	...
	(27, 70, 0, 24490, 0, 0, 0, 0, 'To enter raid instance you myst have completed quest: Return to Khadgar and you have to possess The Master\'s Key', 0, NULL, 0, NULL, 'instance Karazhan (532)'),
	...
	(29, 70, 0, 0, 0, 0, 0, 10445, 'To enter raid instance you must have completed quest: The Vials of Eternity', 0, NULL, 0, NULL, 'instance Hyjal Summit (534)'),
	...
	(47, 70, 0, 32649, 32757, 0, 0, 0, 'To enter raid instance you must have completed quest: A Distraction for Akama', 0, NULL, 0, NULL, 'instance Black Temple (564)'),
