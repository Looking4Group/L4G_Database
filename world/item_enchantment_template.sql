...
-- Dumping structure for table sully_world.item_enchantment_template
...
-- Dumping data for table sully_world.item_enchantment_template: ~28.837 rows (approximately)
