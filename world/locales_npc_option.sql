...
-- Dumping structure for table sully_world.locales_npc_option
...
-- Dumping data for table sully_world.locales_npc_option: ~49 rows (approximately)
DELETE FROM `locales_npc_option`;
