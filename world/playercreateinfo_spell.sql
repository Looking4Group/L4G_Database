...
-- Dumping structure for table progress_world.playercreateinfo_spell
...
-- Dumping data for table progress_world.playercreateinfo_spell: ~2,143 rows (approximately)
