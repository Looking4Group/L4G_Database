...
-- Dumping structure for table sully_world.battleground_template
...
-- Dumping data for table sully_world.battleground_template: ~8 rows (approximately)
...
INSERT INTO `battleground_template` (`id`, `MinPlayersPerTeam`, `MaxPlayersPerTeam`, `MinLvl`, `MaxLvl`, `AllianceStartLoc`, `AllianceStartO`, `HordeStartLoc`, `HordeStartO`) VALUES
	...
	(3, 5, 15, 20, 70, 890, 3.40156, 889, 0.263892),
	(4, 0, 2, 10, 70, 929, 0, 936, 3.14159),
	(5, 0, 2, 10, 70, 939, 0, 940, 3.14159),
	(6, 0, 2, 10, 70, 0, 0, 0, 0),
	(7, 5, 15, 60, 70, 1103, 3.40156, 1104, 0.263892),
