...
-- Dumping structure for table sully_world.playercreateinfo_spell_custom
...
-- Dumping data for table sully_world.playercreateinfo_spell_custom: ~4.658 rows (approximately)
