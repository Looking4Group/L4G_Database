...
-- Dumping structure for table progress_world.playercreateinfo_spell_custom
...
-- Dumping data for table progress_world.playercreateinfo_spell_custom: ~4,366 rows (approximately)
