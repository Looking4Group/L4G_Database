...
-- Dumping structure for table progress_world.completed_cinematic_scripts
...
-- Dumping data for table progress_world.completed_cinematic_scripts: ~1 rows (approximately)
