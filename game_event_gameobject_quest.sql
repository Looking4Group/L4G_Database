...
-- Dumping structure for table progress_world.game_event_gameobject_quest
...
-- Dumping data for table progress_world.game_event_gameobject_quest: ~0 rows (approximately)
